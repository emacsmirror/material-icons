;;; material-icon.el --- Material Icon Theme integration -*- lexical-binding: t -*-
...
;; Usage:
;;
;;   M-x material-icon-dired-icons-mode      — icons in the current Dired buffer
;;   M-x material-icon-ibuffer-icons-mode    — icons in Ibuffer
;;   M-x material-icon-speedbar-icons-mode   — icons globally in Speedbar
;;
;; Customization:
;;
...
(require 'material-icon-dired)
(require 'material-icon-ibuffer)
(require 'material-icon-speedbar)

(provide 'material-icon)
;;; material-icon.el ends here
